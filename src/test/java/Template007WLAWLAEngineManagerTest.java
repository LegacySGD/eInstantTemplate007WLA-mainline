...
public class Template007WLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template007WLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template007WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template007WLAIW/InitOutcome.xml").getDocumentElement();
